                                ...
                                <div className="flex flex-col gap-1 sm:flex-row sm:items-start sm:justify-between">
                                    ...
                                    <div className="flex flex-wrap gap-1 flex-1">
                                        <button
                                            ...
                                            className="flex-1 cursor-pointer rounded-(--cit-radius-md) bg-(--cit-primary) px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-(--cit-primary-hover)"
                                        >
                                            View Certificate
                                        </button>
                                        <a
                                            ...
                                            className="flex-1 text-center inline-flex items-center justify-center rounded-(--cit-radius-md) border border-(--cit-border) bg-(--cit-surface) px-4 py-2.5 text-sm font-semibold text-(--cit-text) transition hover:bg-(--cit-surface-subtle)"
                                        >
                                            Download PDF
                                        </a>
                                    </div>
